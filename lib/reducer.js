...
const baseTypes = Set(["number", "string", "boolean"]);
...
export function deepMerge(a, b) {
  ...
  if (baseTypes.has(typeof a) || baseTypes.has(typeof b)) {
    return b === undefined ? a : b;
  }

  if (!a.mergeDeepWith) {
    const fromJSa = fromJS(a);

    if (!fromJSa.mergeDeepWith) {
      console.log("NO MERGE WITH FUNCTION", typeof a, a, typeof b, b);
    }
